...
import type { Piece, PieceColor, Position } from "../logic/types"
...
export const GameScreen: React.FC<{
    ...
    const onCellClick = (pos: Position, left: boolean) => {
        ...
        if (selectedId) {
            ...
            setPieces(prev => prev.map(p => 
                p.id === selectedId 
                ? { ...p, position: pos, movedThisTurn: true }
                : p
            ))
            setSelectedId(null)
            }
    ...
    const onPieceRightClick = (targetId: string) => {
        ...
        setPieces(prev => 
            ...
            .map(p => p.id === selectedId ? { ...p, movedThisTurn: true } : p)
        )
        setSelectedId(null)
        }
    }
