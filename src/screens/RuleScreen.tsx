...
export const RuleScreen: React.FC<RuleScreenProps> = ({}) => {
    ...
    return (
        ...
        >
            <Typography sx={{ color: UI_PALETTE.text, fontSize: 32, textAlign: "center" }}>{tRule(key, "name")}</Typography>
            ...
            <Button onClick={() => navigate("/library/rules")} sx={{ mt: 2, color: UI_PALETTE.text }}>
                {t("goBack")}
            </Button>
        </Box>
    )
