export const texts_characters = {
    dA: {
        name: {
            enUS: "Umbra, the Agile",
            ptBR: "Umbra, o Ágil",
        },
        description: {
            enUS:
    ...
    dC: {
        name: {
            enUS: "Corvus, the Champion",
            ptBR: "Corvus, o Campeão",
        },
        description: {
            enUS:
    ...
    dD: {
        name: {
            enUS: "Tenebra, the Distance shooter",
            ptBR: "Tenebra, o Atirador à Distância",
        },
        description: {
            enUS:
    ...
    gC: {
        name: {
            enUS: "Nimbus, the Champion",
            ptBR: "Nimbus, o Campeão",
        },
        description: {
            enUS:
    ...
    gD: {
        name: {
            enUS: "Fumus, the Distance shooter",
            ptBR: "Fumus, o Atirador à Distância",
        },
        description: {
            enUS:
    ...
    lD: {
        name: {
            enUS: "Vesper, the Distance shooter",
            ptBR: "Vesper, o Atirador à Distância",
        },
        description: {
            enUS:
...
export const characterKeys = Object.keys(texts_characters) as Array<keyof typeof texts_characters>
